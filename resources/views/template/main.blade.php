            ...
            <nav class="navbar navbar-header navbar-expand-lg" data-background-color="blue2">
                ...
                <div class="container-fluid">
                    <div class="collapse" id="search-nav">
                        <form class="navbar-left navbar-form nav-search mr-md-3" action="{{route('dashboard')}}">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                        ...
                                        <div class="notif-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="notif-content">
                                                    ...
                                                    <span class="block">
                                                        Ready for the meeting today{{ asset('atlantis') }}/examples.
                                                    </span>
                                                    <span class="time">12 minutes ago</span>
                                                </div>
                                            </a>
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="{{ asset('atlantis') }}/examples/assets/img/profile.jpg" alt="{{ asset('atlantis') }}/examples." class="avatar-img rounded-circle">
                                </div>
                            </a>
                                ...
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="{{ route('registrasi')}}">
                                            <span class="sub-item">Daftar Registrasi</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('jk')}}">
